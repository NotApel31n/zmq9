    ...
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            while (true)
            {
                ...
                body.Add(new Pixel(head.XPos, head.YPos, ConsoleColor.White));
        ...
        private static Pixel GetBerryPos(Pixel head, IReadOnlyCollection<Pixel> body)
        {
            ...
            do
            {
                berry = new Pixel(ToEvenNumber(Rand.Next(1, WindowWidth - 2)), Rand.Next(1, WindowHeight - 2), ConsoleColor.White);
